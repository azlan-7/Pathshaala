...
public class StudentsAcademicDetailsView extends AppCompatActivity {
    private RecyclerView educationRecyclerView;
    private EducationAdapter educationAdapter;
    private List<Education> educationList;
    private static final String TAG = "StudentsAcademicDetailsView";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueButton.setOnClickListener(v -> {
            Intent intent = new Intent(StudentsAcademicDetailsView.this, StudentsInfo.class);
        ...
        DatabaseHelper.UserWiseEducationSelect(this, "4", String.valueOf(userId), new DatabaseHelper.UserWiseEducationResultListener() {
            ...
            public void onQueryResult(List<UserWiseEducation> userWiseEducationList) {
                if (userWiseEducationList.isEmpty()) {
                    ...
                    runOnUiThread(() -> Toast.makeText(StudentsAcademicDetailsView.this, "No education records found!", Toast.LENGTH_SHORT).show());
                    return;
                }
            ...
            public void onError(String error) {
                ...
                runOnUiThread(() -> Toast.makeText(StudentsAcademicDetailsView.this, "Error fetching education details!", Toast.LENGTH_SHORT).show());
            }
        });
