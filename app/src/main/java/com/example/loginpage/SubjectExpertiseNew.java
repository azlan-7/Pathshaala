...
public class SubjectExpertiseNew extends AppCompatActivity {
    ...
    private void addChip(String subject, FlexboxLayout container, String category) {
        ...
        // Close Icon Click to remove the chip from the correct category
        chip.setOnCloseIconClickListener(v -> {
            ...
            loadSubjects();  // Refresh the subjects after removal
        });

        // Set chip styles
        chip.setChipBackgroundColorResource(R.color.light_blue); // Default background
        chip.setTextColor(ContextCompat.getColor(this, R.color.blue)); // Text color
        chip.setTextSize(18);  // Bigger font size
        chip.setPadding(40, 15, 40, 15);  // Padding for bigger chips

        // Add chip to the container (either major or minor subject container)
