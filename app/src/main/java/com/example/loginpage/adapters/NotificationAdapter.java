...
//            viewHolder.messageTextView.setText(notification.getMessage());
            viewHolder.messageTextView.setText("A student opted for:");
            ...
            viewHolder.titleTextView.setText(notification.getTitle());
            viewHolder.messageTextView.setText(notification.getMessage());
            // Keep the existing binding for regular messages in item_notification.xml
        }
    }

    // Helper methods to extract information from the message string (same as before)
