...
public class StudentsGrade extends AppCompatActivity {

    private AutoCompleteTextView subjectsDropdown, gradesDropdown, topicDropdown;
    private Button saveButton;
    private ImageView backButton;
    private static final String TAG = "StudentsGrade";
...
//        }
        ...
        backButton.setOnClickListener(v -> startActivity(new Intent(StudentsGrade.this, TeachersInfoSubSection.class)));
        ...
        DatabaseHelper.UserWiseGradesInsert(this, "1", userId, currentProfession, gradeId, subjectId, selfReferralCode,
                new DatabaseHelper.DatabaseCallback() {
                    ...
                    public void onMessage(String message) {
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(StudentsGrade.this, message, Toast.LENGTH_SHORT).show();

                            // Navigate to GradesTaughtView after inserting successfully
                            Intent intent = new Intent(StudentsGrade.this, GradesTaughtView.class);
        ...
        DatabaseHelper.UserWiseGradesSelect(this, "4", String.valueOf(userId), new DatabaseHelper.UserWiseGradesResultListener() {
            ...
            public void onQueryResult(List<UserWiseGrades> userWiseGradesList) {
                if (userWiseGradesList == null || userWiseGradesList.isEmpty()) {
                    ...
                    Toast.makeText(StudentsGrade.this, "No Grades Found!", Toast.LENGTH_SHORT).show();
                    return;
                }
