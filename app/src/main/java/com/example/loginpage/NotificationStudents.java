...
public class NotificationStudents extends AppCompatActivity {
    ...
    private void displayNotifications(List<Notification> notifications) {
        ...
        for (Notification notification : notifications) {
            Log.d("NotificationStudents", "Displaying notification: " + notification.getTitle()); //Log each notification.
        ...
        Log.d("NotificationStudents", "Notifications displayed.");//log when finished.
    }
}
